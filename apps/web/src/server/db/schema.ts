...
export const taskDependency = pgTable(
  ...
  (t) => [
    index("task_dep_task_id_idx").on(t.taskId),
    index("task_dep_depends_on_idx").on(t.dependsOnTaskId),
  ],
);
...
export type NewTaskDependency = typeof taskDependency.$inferInsert;
